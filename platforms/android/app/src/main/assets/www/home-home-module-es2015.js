...
let ApiExternaService = class ApiExternaService {
    constructor(http) {
        this.http = http;
    ...
    saveFile(logo) {
        ...
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'content-type': 'application/json', 'Authorization': this.key });
        return this.http.post(this.url, body, { headers: headers }).toPromise();
    }
};
ApiExternaService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
ApiExternaService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _api_externa_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../api-externa.service */ "./src/app/api-externa.service.ts");
...
/* harmony import */ var _ionic_native_file_chooser_ngx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic-native/file-chooser/ngx */ "./node_modules/@ionic-native/file-chooser/__ivy_ngcc__/ngx/index.js");
...
let HomePage = class HomePage {
    constructor(api, camera, fileChooser) {
        this.api = api;
        this.camera = camera;
